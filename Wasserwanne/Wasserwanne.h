...
#define POWER_DDRX							DDRA
#define POWER_PORTX							PORTA
#define POWER_BIT							_BV(6)
#define INIT_POWER_BIT()					(POWER_DDRX |= POWER_BIT)
#define SET_POWER_BIT()						(POWER_PORTX |= POWER_BIT)
#define CLEAR_POWER_BIT()					(POWER_PORTX &= ~POWER_BIT)
