...
/*@{*/
#ifndef F_CPU
	#define F_CPU 1000000UL			/**< Change this to the clock-rate of your microcontroller */
#endif
...
#define LCD_COLS			16	/**< Enter the number of rows of your display here */
...
#define LCD_E_PIN			2	/**< LCD-Pin D4 is connected to P6 on the PCF8574 */
#define LCD_BL_PIN			3	/**< this pin is not connected */
//#define LCD_EMPTY_PIN				/**< this pin is not connected */
/*@}*/
...
#define LCD_D0				(1 << 0)	/**< bit 0 in 1st lower nibble */
#define LCD_D1				(1 << 1)	/**< bit 1 in 1st lower nibble */
#define LCD_D2				(1 << 2)	/**< bit 2 in 1st lower nibble */
#define LCD_D3				(1 << 3)	/**< bit 3 in 1st lower nibble */
 ...
 */
bool lcd_gotoxy(unsigned char x, unsigned char y);	//-	Go to position
...
/**
 ...
 \retval false if not successfull
 */
bool lcd_putcharxy(unsigned char x, unsigned char y, unsigned char value);	//-	Put char to position
...
/**
 ...
 \retval false if not successfull
 */
bool lcd_printxyCR(unsigned char x, unsigned char y, unsigned char *string);		//-	Print string to position 
...
/**
 ...
 \retval false if not successfull
 */
bool lcd_printxyCRLF(unsigned char x, unsigned char y, unsigned char *string);	//-	Print string to position 
											//-	(If string is longer than LCD_ROWS
